...
export const SISGES_ICON_CATALOG: readonly SisgesIconDefinition[] = [
  ...
  defineIcon('activity', 'Actividad', 'generales', ['actividad', 'pulso', 'sesión']),
  defineIcon('clock', 'Reloj', 'generales', ['reloj', 'tiempo', 'duración']),
  defineIcon('gauge', 'Indicador', 'generales', ['indicador', 'promedio', 'medición']),
  defineIcon('refresh', 'Actualizar', 'generales', ['actualizar', 'recargar', 'sincronizar']),
  defineIcon('chevron-right', 'Ir al detalle', 'generales', ['derecha', 'detalle', 'navegar']),
  defineIcon('close', 'Cerrar', 'generales', ['cerrar', 'salir', 'x']),
