...
import AccesosPerfilPermissionsPanel from './AccessPermissionsPanel';

import AccesosPerfilTree from './AccessTree';

import AsignarAccesosPerfilErrorSummary from './AccessAssignmentErrorSummary';

const rootItem: AccessTreeItem = {
  idModulo: 1,
  nombre: 'Root',
  descripcion: '',
  codigo: 'Root',
...
const secondItem: AccessTreeItem = {
  ...item,
  idModulo: 11,
...
const powerBiItem: AccessTreeItem = {
  ...item,
  idModulo: 999,
