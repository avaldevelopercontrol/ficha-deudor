...
interface DetallePromesaCarteraPaginationProps {
  className: string;
...
export const DetallePromesaCarteraPagination: React.FC<
  DetallePromesaCarteraPaginationProps
> = ({
  className,
  pagination,
  requestedPage,
...
export default DetallePromesaCarteraPagination;
