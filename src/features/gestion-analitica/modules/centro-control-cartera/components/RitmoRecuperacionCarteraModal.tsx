...
interface RitmoRecuperacionCarteraModalProps {
  isOpen: boolean;
  onClose: () => void;
  target: MetaCarteraProgress;
...
export const RitmoRecuperacionCarteraModal: React.FC<
  RitmoRecuperacionCarteraModalProps
> = ({
  isOpen,
  onClose,
  target,
...
export default RitmoRecuperacionCarteraModal;
