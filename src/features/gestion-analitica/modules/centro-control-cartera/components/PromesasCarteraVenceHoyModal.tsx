...
import { usePromesasCarteraVenceHoy } from '../hooks/usePromesasCarteraVenceHoy';
...
interface PromesasCarteraVenceHoyModalProps {
  isOpen: boolean;
  onClose: () => void;
  context: Pick<
    PortfolioOperationalContext,
...
const DEFAULT_SORT_KEY: PromesasCarteraVenceHoySortKey =
  'outstandingAmount';
const DEFAULT_SORT_DIRECTION: PortfolioSortDirection = 'desc';
const DUE_TODAY_SORT_KEYS: readonly PromesasCarteraVenceHoySortKey[] = [
  'debtorId',
  'promiseAmount',
  'paidAmount',
  'outstandingAmount',
...
export const PromesasCarteraVenceHoyModal: React.FC<
  PromesasCarteraVenceHoyModalProps
...
export default PromesasCarteraVenceHoyModal;
