...
export const parseOpcionesFiltroCarteraApiResponse: ContractParser<OpcionesFiltroCarteraApiResponse> = (
  value
) => {
  ...
  return value as OpcionesFiltroCarteraApiResponse;
};
...
export const parseMetaCarteraProgressApiResponse: ContractParser<MetaCarteraProgressApiResponse> = (
  value
) => {
  ...
  return value as MetaCarteraProgressApiResponse;
};

export const parsePromesasCarteraApiResponse: ContractParser<PromesasCarteraApiResponse> = (
  value
) => {
  ...
  return value as PromesasCarteraApiResponse;
};

export const parseEvolucionCarteraApiResponse: ContractParser<EvolucionCarteraApiResponse> = (
  value
) => {
...
export const parsePanoramaCarteraApiResponse: ContractParser<PanoramaCarteraApiResponse> = (
  ...
  parseMetaCarteraProgressApiResponse(response.targetProgress);
  parsePromesasCarteraApiResponse(response.promises);
  parseEvolucionCarteraApiResponse(response.evolution);

  return value as PanoramaCarteraApiResponse;
};

export const parseInicializacionCarteraApiResponse: ContractParser<InicializacionCarteraApiResponse> = (
  value
) => {
  const contract = 'Portfolio Bootstrap';
  const response = expectRecord(value, contract, '$');

  parseOpcionesFiltroCarteraApiResponse(response.filterOptions);
  if (response.overview !== null) {
    parsePanoramaCarteraApiResponse(response.overview);
  }

  return value as InicializacionCarteraApiResponse;
};
