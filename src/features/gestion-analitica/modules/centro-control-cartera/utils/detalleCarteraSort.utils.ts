...
export const DETALLE_CARTERA_SORT_OPTIONS = {
  advisors: [
    { id: 'managementCount', label: 'Gestiones' },
    { id: 'managedDebtorCount', label: 'Deudores gestionados' },
...
export const sortAdvisorPerformanceByHighest = (
  ...
  switch (sortKey) {
    ...
    case 'managedDebtorCount':
      return sortByNumericValueDescending(
        items,
        (item) => item.managedDebtorCount
      );
    case 'rpcRate':
...
export const sortRendimientoCampanaByHighest = (
