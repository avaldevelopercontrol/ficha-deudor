...
export const CARTERA_UNASSIGNED_SUPERVISOR_FILTER_ID =
  '__unassigned__';
...
const CARTERA_CAMPAIGN_MONTH_LABELS = [
  'Enero',
  'Febrero',
  'Marzo',
  'Abril',
...
export const getPortfolioSupervisorOptionsForContext = (
  ...
  return [
    ...contextualOptions,
    {
      id: CARTERA_UNASSIGNED_SUPERVISOR_FILTER_ID,
