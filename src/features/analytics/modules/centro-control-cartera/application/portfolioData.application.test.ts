  ...
  [
    ...
    test(
      ...
      async () => {
        ...
        assert.equal(
          requests[0],
          '/analytics-api/v1/Analitica/CentroControlCartera/Panorama?campana=2026-08&unidadNegocio=CLARO+GOBIERNO&fechaDesde=2026-08-05&fechaHasta=2026-08-13&idSubCartera=29&idClienteCrm=95'
        );
      }
    ),
    test(
