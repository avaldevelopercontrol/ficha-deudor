...
import { DetallePromesaCarteraPagination } from './DetallePromesaCarteraPagination';

export const suite = defineSuite('DetallePromesaCarteraPagination', [
  test('no renderiza paginación cuando no existen registros', () => {
    const html = renderToStaticMarkup(
      <DetallePromesaCarteraPagination
