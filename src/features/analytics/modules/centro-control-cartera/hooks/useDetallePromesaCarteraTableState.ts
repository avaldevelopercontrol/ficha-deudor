...
interface UseDetallePromesaCarteraTableStateParams<
...
export function useDetallePromesaCarteraTableState<
  TFilter extends string,
  TSortKey extends string,
>({
  defaultFilter,
  ...
  defaultPageSize = 5,
}: UseDetallePromesaCarteraTableStateParams<TFilter, TSortKey>) {
